...
// ENLACES CORREGIDOS: "Mi Tienda" ahora apunta correctamente a /dashboard/store
const navItems = [
  { name: 'Resumen', href: '/dashboard', icon: HomeIcon },
  { name: 'Mi Agenda', href: '/dashboard/agenda', icon: CalendarIcon },
  { name: 'Mi Tienda', href: '/dashboard/store', icon: ShoppingBagIcon }, // <-- Corregido aquí
  { name: 'Mis Clientes', href: '/dashboard/clientes', icon: UsersIcon },
];
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-gray-50 md:pb-0">
      ...
      {/* 📱 Mobile Bottom Navigation (Oculto en computadoras) */}
